...
It supports many features including:
    ...
    - Multiple types of field solvers (incl. for :ref:`Maxwell's equations <theory-em-pic>`, :ref:`Poisson's equation <theory-electrostatic-pic>`, and :ref:`Maxwell-Ampere coupled with Ohm's law <theory-kinetic-fluid-hybrid-model>`)
