...
For continuous integration we currently use clang version 21 and it is recommended to use this version locally as well.
...
.. code-block:: bash
   ...
   export CLANGXX=clang++-21
   export CLANGTIDY=clang-tidy-21
