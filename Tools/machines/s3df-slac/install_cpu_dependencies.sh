...
# Check: ######################################################################
#
#   Was s3df_cpu_warpx.profile sourced and configured correctly?
if [ -z ${proj-} ]; then echo "WARNING: The 'proj' variable is not yet set in your s3df_cpu_warpx.profile file! Please edit its line 2 to continue!"; exit 1; fi
...
then
    ...
    echo "Please edit line 2 of your s3df_cpu_warpx.profile file to continue!"
    exit
fi
