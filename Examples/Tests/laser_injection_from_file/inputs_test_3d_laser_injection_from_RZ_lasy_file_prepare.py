...
# injection of a laser pulse from an external lasy file in RZ geometry into a
# 3D Cartesian simulation:
# - Generate an input lasy file with a Gaussian laser pulse stored in RZ geometry.
...
# Create a Gaussian laser in RZ geometry using lasy
...
laser.write_to_file("gaussian_laser_RZ")
