...
ux_ele_cw_0, uy_ele_cw_0, uz_ele_cw_0, w_ele_cw_0, x_ele_cw_0, y_ele_cw_0, z_ele_cw_0 = series.get_particle(["ux", "uy", "uz","w", "x", "y", "z"], species="beam1", iteration=0)
ux_pos_cw_0, uy_pos_cw_0, uz_pos_cw_0, w_pos_cw_0, x_pos_cw_0, y_pos_cw_0, z_pos_cw_0 = series.get_particle(["ux", "uy", "uz","w", "x", "y", "z"], species="beam2", iteration=0)

# sim 2: init gaussian bunch, apply cw, rotate by phi
series = OpenPMDTimeSeries(os.path.join(sim_folder, "diags_cw_on", "diag1"))
ux_ele_cw_1, uy_ele_cw_1, uz_ele_cw_1, w_ele_cw_1, x_ele_cw_1, y_ele_cw_1, z_ele_cw_1 = series.get_particle(["ux", "uy", "uz","w", "x", "y", "z"], species="beam1", iteration=0)
ux_pos_cw_1, uy_pos_cw_1, uz_pos_cw_1, w_pos_cw_1, x_pos_cw_1, y_pos_cw_1, z_pos_cw_1 = series.get_particle(["ux", "uy", "uz","w", "x", "y", "z"], species="beam2", iteration=0)
...
ax[0].plot(x_ele_cw_0[ x_ele_pos_idx]/sigma_x, ux_ele_cw_0[ x_ele_pos_idx]/sigma_px, "o", c="darkred", label=r"e- ($Rx>0$)")
ax[0].plot(x_ele_cw_0[~x_ele_pos_idx]/sigma_x, ux_ele_cw_0[~x_ele_pos_idx]/sigma_px, "o", c="darkblue", label=r"e- ($Rx<0$)")

ax[0].plot(x_pos_cw_0[ x_pos_pos_idx]/sigma_x, ux_pos_cw_0[ x_pos_pos_idx]/sigma_px, "rx", label=r"e+ ($Rx>0$)")
ax[0].plot(x_pos_cw_0[~x_pos_pos_idx]/sigma_x, ux_pos_cw_0[~x_pos_pos_idx]/sigma_px, "bx", label=r"e+ ($Rx<0$)")

ax[1].plot(y_ele_cw_0[ x_ele_pos_idx]/sigma_y, uy_ele_cw_0[ x_ele_pos_idx]/sigma_py, "o", c="darkred",  label=r"e- ($Rx>0$)")
ax[1].plot(y_ele_cw_0[~x_ele_pos_idx]/sigma_y, uy_ele_cw_0[~x_ele_pos_idx]/sigma_py, "o", c="darkblue", label=r"e- ($Rx<0$)")

ax[1].plot(y_pos_cw_0[ x_pos_pos_idx]/sigma_y, uy_pos_cw_0[ x_pos_pos_idx]/sigma_py, "rx", label=r"e+ ($Rx>0$)")
ax[1].plot(y_pos_cw_0[~x_pos_pos_idx]/sigma_y, uy_pos_cw_0[~x_pos_pos_idx]/sigma_py, "bx", label=r"e+ ($Rx<0$)")
...
ax[0].plot(x_ele_cw_1[ x_ele_pos_idx]/sigma_x, ux_ele_cw_1[ x_ele_pos_idx]/sigma_px, "o", c="darkred", label=r"e- ($Rx>0$)")
ax[0].plot(x_ele_cw_1[~x_ele_pos_idx]/sigma_x, ux_ele_cw_1[~x_ele_pos_idx]/sigma_px, "o", c="darkblue", label=r"e- ($Rx<0$)")

ax[0].plot(x_pos_cw_1[ x_pos_pos_idx]/sigma_x, ux_pos_cw_1[ x_pos_pos_idx]/sigma_px, "rx", label=r"e+ ($Rx>0$)")
ax[0].plot(x_pos_cw_1[~x_pos_pos_idx]/sigma_x, ux_pos_cw_1[~x_pos_pos_idx]/sigma_px, "bx", label=r"e+ ($Rx<0$)")

ax[1].plot(y_ele_cw_1[ x_ele_pos_idx]/sigma_y, uy_ele_cw_1[ x_ele_pos_idx]/sigma_py, "o", c="darkred",  label=r"e- ($Rx>0$)")
ax[1].plot(y_ele_cw_1[~x_ele_pos_idx]/sigma_y, uy_ele_cw_1[~x_ele_pos_idx]/sigma_py, "o", c="darkblue", label=r"e- ($Rx<0$)")

ax[1].plot(y_pos_cw_1[ x_pos_pos_idx]/sigma_y, uy_pos_cw_1[ x_pos_pos_idx]/sigma_py, "rx", label=r"e+ ($Rx>0$)")
ax[1].plot(y_pos_cw_1[~x_pos_pos_idx]/sigma_y, uy_pos_cw_1[~x_pos_pos_idx]/sigma_py, "bx", label=r"e+ ($Rx<0$)")
...
ux_ele_cw_1_init = ux_ele_cw_1_rot - .5 * acw_ele * uy_ele_cw_1_init**2
...
ux_pos_cw_1_init = ux_pos_cw_1_rot - .5 * acw_pos * uy_pos_cw_1_init**2
...
ax[0].plot(x_ele_cw_1_init[ x_ele_pos_idx]/sigma_x, ux_ele_cw_1_init[ x_ele_pos_idx]/sigma_px, "o", c="darkred", label=r"e- ($Rx>0$)")
ax[0].plot(x_ele_cw_1_init[~x_ele_pos_idx]/sigma_x, ux_ele_cw_1_init[~x_ele_pos_idx]/sigma_px, "o", c="darkblue", label=r"e- ($Rx<0$)")

ax[0].plot(x_pos_cw_1_init[ x_pos_pos_idx]/sigma_x, ux_pos_cw_1_init[ x_pos_pos_idx]/sigma_px, "rx", label=r"e+ ($Rx>0$)")
ax[0].plot(x_pos_cw_1_init[~x_pos_pos_idx]/sigma_x, ux_pos_cw_1_init[~x_pos_pos_idx]/sigma_px, "bx", label=r"e+ ($Rx<0$)")

ax[1].plot(y_ele_cw_1_init[ x_ele_pos_idx]/sigma_y, uy_ele_cw_1_init[ x_ele_pos_idx]/sigma_py, "o", c="darkred",  label=r"e- ($Rx>0$)")
ax[1].plot(y_ele_cw_1_init[~x_ele_pos_idx]/sigma_y, uy_ele_cw_1_init[~x_ele_pos_idx]/sigma_py, "o", c="darkblue", label=r"e- ($Rx<0$)")

ax[1].plot(y_pos_cw_1_init[ x_pos_pos_idx]/sigma_y, uy_pos_cw_1_init[ x_pos_pos_idx]/sigma_py, "rx", label=r"e+ ($Rx>0$)")
ax[1].plot(y_pos_cw_1_init[~x_pos_pos_idx]/sigma_y, uy_pos_cw_1_init[~x_pos_pos_idx]/sigma_py, "bx", label=r"e+ ($Rx<0$)")
...
assert np.allclose(uz_ele_cw_1_init/gamma, uz_ele_cw_0_init/gamma, rtol=1e-14, atol=1e-14)
assert np.allclose(uz_pos_cw_1_init/gamma, uz_pos_cw_0_init/gamma, rtol=1e-14, atol=1e-14)
