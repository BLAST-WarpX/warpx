...
(
    ...
    z,
    w,
) = ts.get_particle(["x", "y", "z", "w"], species="beam1", iteration=0, plot=False)
...
print(sx)
print(sx_theory)
print((sx - sx_theory) / sx_theory)
print((abs(sx - sx_theory) / sx_theory).max())
print(sy)
print(sy_theory)
print((sy - sy_theory) / sy_theory)
print((abs(sy - sy_theory) / sy_theory).max())
assert np.allclose(sx, sx_theory, rtol=0.052, atol=0)
