...
"""Manufactured grey-FLD radiation force and work test in RCYLINDER."""
...
# The localized LTE source occupies cell 1. Derive its realized emission from
# the independently conserved internal-energy ledger, avoiding assumptions
# about the RCYL cell-to-node heat-capacity limiter.
emitted = -radiation[-1, 9]
