...
# FieldDiagnostic in openPMD/ADIOS2 format, writing at every step
...
# -------------------------------------------------------------------------
print("\n" + "=" * 60)
print("Testing add_field_to_diagnostic with openPMD/ADIOS2 output")
print("=" * 60)
...
series = io.Series(
    "diags/field_output_test/openpmd_%06T.bp5",
    io.Access.read_only
)
