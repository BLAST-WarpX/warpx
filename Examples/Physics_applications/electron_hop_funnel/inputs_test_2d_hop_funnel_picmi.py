...
class Geometry():
    ...
    def calcDomain(self,xmin=0.0,ymin=0.0):
        ymax = self.yFunnel + self.yHopElectrode + self.yHopAnodeGap + \
            self.yCathodeFunnelGap + ymin
    ...
    def alignBlockingFactor(self,xFudgeVariable='xFunnelBuffer',yFudgeVariable='yHopAnodeGap'):
...
# simulation setup
##########################
layout_elec = picmi.PseudoRandomLayout(n_macroparticles_per_cell=number_per_cell, grid=grid)
