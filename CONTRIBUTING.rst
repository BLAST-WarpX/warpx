...
- It is time to communicate your changes: write a title and a description for your PR.
  The description is pre-filled with our `pull request template <https://github.com/BLAST-WarpX/warpx/blob/development/.github/pull_request_template.md>`__, which asks the three questions that reviewers need answered:
...
- Work through the ``## TODO`` check-list of the template before you ask for a review, especially the manual self-review.
  This matters most if you drafted the changes with an LLM, see :ref:`developers-llm`.
