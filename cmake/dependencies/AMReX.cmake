macro(find_amrex)
    ...
    if(WarpX_amrex_internal OR WarpX_amrex_src)
        ...
        find_package(AMReX 6aa80dfba6df10f3e711153ea63fd7169df97da8 CONFIG REQUIRED COMPONENTS ${COMPONENT_ASCENT} ${COMPONENT_CATALYST} ${COMPONENT_DIMS} ${COMPONENT_EB} ${COMPONENT_FFT} PARTICLES ${COMPONENT_PIC} ${COMPONENT_PRECISION} ${COMPONENT_SENSEI} LSOLVERS)
...
set(WarpX_amrex_branch "6aa80dfba6df10f3e711153ea63fd7169df97da8"
    CACHE STRING
