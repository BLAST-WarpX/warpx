...
- **`dependencies.json`**: Auto-updated weekly/monthly by CI via `Tools/Release/update_dependencies.py`. Do not modify unless explicitly instructed (e.g., to pin a bugfix branch of a dependency).
- **`Regression/Checksum/benchmarks_json/*.json`**: Auto-generated by the test framework (`CHECKSUM_RESET=ON ctest`). Do not modify unless explicitly instructed (e.g., to update expected values from a CI run).
