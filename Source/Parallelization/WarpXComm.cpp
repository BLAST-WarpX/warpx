...
{
    WARPX_PROFILE("WarpX::UpdateAuxilaryData()", ablastr::profiler::Always);
...
WarpX::SyncCurrent (const std::string& current_fp_string)
{
    ...
    WARPX_PROFILE("WarpX::SyncCurrent()", ablastr::profiler::Always);
...
{
    WARPX_PROFILE("WarpX::SyncMassMatricesPC()", ablastr::profiler::Always);
...
{
    WARPX_PROFILE("WarpX::SyncRho()", ablastr::profiler::Always);
