...
{
    WARPX_PROFILE("MultiReducedDiags::ComputeDiags()", ablastr::profiler::when::Always);
...
{
    WARPX_PROFILE("MultiReducedDiags::ComputeDiagsMidStep()", ablastr::profiler::when::Always);
