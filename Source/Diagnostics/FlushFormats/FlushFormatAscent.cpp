    ...
    bool /*isLastBTDFlush*/) const
{
    ...
    WARPX_PROFILE("FlushFormatAscent::WriteToFile()", ablastr::profiler::WhenToProfile::Always);
    ...
    // wrap mesh data
    WARPX_PROFILE_VAR("FlushFormatAscent::WriteToFile::MultiLevelToBlueprint", prof_ascent_mesh_blueprint, ablastr::profiler::WhenToProfile::Always);
    ...
    WARPX_PROFILE_VAR("FlushFormatAscent::WriteToFile::WriteParticles", prof_ascent_particles, ablastr::profiler::WhenToProfile::Always);
    ...
    WARPX_PROFILE_VAR("FlushFormatAscent::WriteToFile::publish", prof_ascent_publish, ablastr::profiler::WhenToProfile::Always);
    ...
    WARPX_PROFILE_VAR("FlushFormatAscent::WriteToFile::execute", prof_ascent_execute, ablastr::profiler::WhenToProfile::Always);
