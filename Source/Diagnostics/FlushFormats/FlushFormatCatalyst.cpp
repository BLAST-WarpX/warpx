    ...
    bool /*isLastBTDFlush*/) const
{
    ...
    WARPX_PROFILE("FlushFormatCatalyst::WriteToFile()", ablastr::profiler::WhenToProfile::Always);
    ...
    // Mesh data
    WARPX_PROFILE_VAR("FlushFormatCatalyst::WriteToFile::MultiLevelToBlueprint", prof_catalyst_mesh_blueprint, ablastr::profiler::WhenToProfile::Always);
    conduit::Node node;
    ...
    // Particle data
    WARPX_PROFILE_VAR("FlushFormatCatalyst::WriteToFile::WriteParticles", prof_catalyst_particles, ablastr::profiler::WhenToProfile::Always);
    ...
    // Execution
    WARPX_PROFILE_VAR("FlushFormatCatalyst::WriteToFile::execute", prof_catalyst_execute, ablastr::profiler::WhenToProfile::Always);
