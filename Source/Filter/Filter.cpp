...
{
    WARPX_PROFILE("Filter::ApplyStencil(MultiFab)", ablastr::profiler::WhenToProfile::Always);
...
{
    WARPX_PROFILE("Filter::ApplyStencil(FArrayBox)", ablastr::profiler::WhenToProfile::Always);
