...
{
    WARPX_PROFILE_REGION("WarpX::Evolve()", ablastr::profiler::Always);
    WARPX_PROFILE("WarpX::Evolve()", ablastr::profiler::Always);
    ...
    {
        WARPX_PROFILE("WarpX::Evolve::step", ablastr::profiler::Always);
...
{
    WARPX_PROFILE("WarpX::OneStep()", ablastr::profiler::Always);
...
{
    WARPX_PROFILE("WarpX::OneStep_nosub()", ablastr::profiler::Always);
