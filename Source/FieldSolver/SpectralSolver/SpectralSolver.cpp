...
SpectralSolver::ForwardTransform (const int lev,
                                  ...
                                  const int i_comp)
{
    WARPX_PROFILE("SpectralSolver::ForwardTransform", ablastr::profiler::Always);
...
SpectralSolver::BackwardTransform( const int lev,
                                   ...
                                   const int i_comp )
{
    WARPX_PROFILE("SpectralSolver::BackwardTransform", ablastr::profiler::Always);
    field_data.BackwardTransform(lev, mf, field_index, fill_guards, i_comp);
}

void
SpectralSolver::pushSpectralFields(){
    WARPX_PROFILE("SpectralSolver::pushSpectralFields", ablastr::profiler::Always);
