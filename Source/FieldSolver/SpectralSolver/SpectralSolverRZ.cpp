...
SpectralSolverRZ::ForwardTransform (const int lev,
                                    ...
                                    int const i_comp) {
    WARPX_PROFILE("SpectralSolverRZ::ForwardTransform", ablastr::profiler::Always);
...
SpectralSolverRZ::BackwardTransform (const int lev,
                                     ...
                                     int const i_comp) {
    WARPX_PROFILE("SpectralSolverRZ::BackwardTransform", ablastr::profiler::Always);
...
SpectralSolverRZ::pushSpectralFields (const bool doing_pml) {
    WARPX_PROFILE("SpectralSolverRZ::pushSpectralFields", ablastr::profiler::Always);
