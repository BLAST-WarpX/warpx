...
void HybridPICModel::CalculatePlasmaCurrent (
    ...
    const int lev)
{
    WARPX_PROFILE("HybridPICModel::CalculatePlasmaCurrent()", ablastr::profiler::WhenToProfile::Always);
...
{
    WARPX_PROFILE("WarpX::HybridPICSolveE()", ablastr::profiler::WhenToProfile::Always);
...
{
    WARPX_PROFILE("WarpX::CalculateElectronPressure()", ablastr::profiler::WhenToProfile::Always);
