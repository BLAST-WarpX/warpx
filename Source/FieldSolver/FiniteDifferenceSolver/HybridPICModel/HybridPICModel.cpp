...
void HybridPICModel::BfieldEvolveRK (
    ...
    ablastr::fields::MultiLevelScalarField const& rhofield,
    amrex::Vector<std::array< std::unique_ptr<amrex::iMultiFab>,3 > >& eb_update_E,
    amrex::Real dt, SubcyclingStage subcycling_stage,
    IntVect ng, std::optional<bool> nodal_sync )
{
    ...
    {
        BfieldEvolveRK(
            Bfield, Efield, Jfield, rhofield, eb_update_E, dt, lev, subcycling_stage,
            ng, nodal_sync
        );
    }
}
...
void HybridPICModel::BfieldEvolveRK (
    ...
    ablastr::fields::MultiLevelScalarField const& rhofield,
    amrex::Vector<std::array< std::unique_ptr<amrex::iMultiFab>,3 > >& eb_update_E,
    amrex::Real dt, int lev, SubcyclingStage subcycling_stage,
    IntVect ng, std::optional<bool> nodal_sync )
{
    ...
    FieldPush(
        ...
        0.5_rt*dt, subcycling_stage, ng, nodal_sync
    );
    ...
    FieldPush(
        Bfield, Efield, Jfield, rhofield, eb_update_E,
        dt, subcycling_stage, ng, nodal_sync
    );
    ...
    IntVect ng, std::optional<bool> nodal_sync )
{
    ...
    warpx.EvolveB(dt, subcycling_stage, t_old);
