...
{
    WARPX_PROFILE("WarpX::ComputeMagnetostaticField", ablastr::profiler::WhenToProfile::Always);
...
WarpX::AddMagnetostaticFieldLabFrame()
{
    ...
    WARPX_PROFILE("WarpX::AddMagnetostaticFieldLabFrame", ablastr::profiler::WhenToProfile::Always);
