...
{
    WARPX_PROFILE("WarpX::ComputeMagnetostaticField", ablastr::profiler::when::Always);
...
WarpX::AddMagnetostaticFieldLabFrame()
{
    ...
    WARPX_PROFILE("WarpX::AddMagnetostaticFieldLabFrame", ablastr::profiler::when::Always);
