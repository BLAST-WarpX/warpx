...
void WarpX::HybridPICEvolveFields ()
{
    ...
    if(m_hybrid_pic_model->m_solve_electron_energy_equation){
        ...
        hybrid_electron_fl->HybridInitializeUe(m_fields, *current_fp_temp[finest_level][0], *current_fp_temp[finest_level][1], *current_fp_temp[finest_level][2], finest_level);
