    ...
    const bool apply_kspace_filter)
{
    ...
    for (int lev = 0; lev <= finest_level; ++lev)
    {
        ...
        idx_jx = (time_dependency_J == JInTime::Linear) ? static_cast<int>(Idx.Jx_new) : static_cast<int>(Idx.Jx_mid);
        idx_jy = (time_dependency_J == JInTime::Linear) ? static_cast<int>(Idx.Jy_new) : static_cast<int>(Idx.Jy_mid);
        idx_jz = (time_dependency_J == JInTime::Linear) ? static_cast<int>(Idx.Jz_new) : static_cast<int>(Idx.Jz_mid);
