...
{
    WARPX_PROFILE("WarpX::EvolveB()", ablastr::profiler::WhenToProfile::Always);
...
{
    WARPX_PROFILE("WarpX::EvolveE()", ablastr::profiler::WhenToProfile::Always);
...
WarpX::EvolveF (int lev, PatchType patch_type, amrex::Real a_dt, int const rho_comp)
{
    ...
    WARPX_PROFILE("WarpX::EvolveF()", ablastr::profiler::WhenToProfile::Always);
...
WarpX::EvolveG (int lev, PatchType patch_type, amrex::Real a_dt)
{
    ...
    WARPX_PROFILE("WarpX::EvolveG()", ablastr::profiler::WhenToProfile::Always);
...
WarpX::MacroscopicEvolveE (int lev, amrex::Real a_dt, amrex::Real start_time) {
    ...
    WARPX_PROFILE("WarpX::MacroscopicEvolveE()", ablastr::profiler::WhenToProfile::Always);
