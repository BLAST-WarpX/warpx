...
struct FindEmbeddedBoundaryIntersection {
                     ...
                     int src_i, int dst_i) const noexcept
    {
        ...
        dst.m_runtime_rdata[m_delta_index][dst_i] = m_cur_time + (1._rt- dt_fraction)*m_dt;
...
struct CopyAndTimestamp {
                     ...
                     int src_i, int dst_i) const noexcept
    {
        ...
        dst.m_runtime_idata[m_step_index][dst_i] = m_step;
        dst.m_runtime_rdata[m_delta_index][dst_i] = m_cur_time; //delta_fraction is initialized to zero
                    ...
                    for(PIter pti(pc, lev); pti.isValid(); ++pti)
                    {
                        ...
                        }
                        {
                          ...
                          amrex::filterAndTransformParticles(ptile_buffer, ptile,
                                                             predicate,
                                                             CopyAndTimestamp{step_scraped_index, time_scraped_index, normal_index,
