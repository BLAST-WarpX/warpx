                                        ...
                                        amrex::Real const dt, amrex::Real const relative_time, PushType push_type)
{
    ...
    WARPX_PROFILE_VAR_NS("WarpXParticleContainer::DepositCurrent::Sorting", blp_sort, ablastr::profiler::WhenToProfile::IfSyncEnabled);
    WARPX_PROFILE_VAR_NS("WarpXParticleContainer::DepositCurrent::FindMaxTilesize",
            blp_get_max_tilesize, ablastr::profiler::WhenToProfile::IfSyncEnabled);
    WARPX_PROFILE_VAR_NS("WarpXParticleContainer::DepositCurrent::DirectCurrentDepKernel",
            direct_current_dep_kernel, ablastr::profiler::WhenToProfile::IfSyncEnabled);
    WARPX_PROFILE_VAR_NS("WarpXParticleContainer::DepositCurrent::EsirkepovCurrentDepKernel",
            esirkepov_current_dep_kernel, ablastr::profiler::WhenToProfile::IfSyncEnabled);
    WARPX_PROFILE_VAR_NS("WarpXParticleContainer::DepositCurrent::CurrentDeposition", blp_deposit, ablastr::profiler::WhenToProfile::IfSyncEnabled);
    WARPX_PROFILE_VAR_NS("WarpXParticleContainer::DepositCurrent::Accumulate", blp_accumulate, ablastr::profiler::WhenToProfile::IfSyncEnabled);
                                        ...
                                        amrex::Real dt )
{
    ...
    WARPX_PROFILE_VAR_NS("WarpXParticleContainer::DepositCurrentAndMassMatrices::Sorting", blp_sort, ablastr::profiler::WhenToProfile::IfSyncEnabled);
    ...
    WARPX_PROFILE_VAR_NS("WarpXParticleContainer::DepositCurrentAndMassMatrices::EsirkepovCurrentDepKernel",
            esirkepov_current_dep_kernel, ablastr::profiler::WhenToProfile::IfSyncEnabled);
    WARPX_PROFILE_VAR_NS("WarpXParticleContainer::DepositCurrentAndMassMatrices::CurrentDeposition", blp_deposit, ablastr::profiler::WhenToProfile::IfSyncEnabled);
    WARPX_PROFILE_VAR_NS("WarpXParticleContainer::DepositCurrentAndMassMatrices::Accumulate", blp_accumulate, ablastr::profiler::WhenToProfile::IfSyncEnabled);
                                       ...
                                       const int thread_num, const int lev, const int depos_lev)
{
    ...
    if (WarpX::do_shared_mem_charge_deposition)
    {
        ...
        WARPX_PROFILE_VAR_NS("WarpXParticleContainer::DepositCharge::Sorting", blp_sort, ablastr::profiler::WhenToProfile::IfSyncEnabled);
        WARPX_PROFILE_VAR_NS("WarpXParticleContainer::DepositCharge::ChargeDeposition", blp_ppc_chd, ablastr::profiler::WhenToProfile::IfSyncEnabled);
        WARPX_PROFILE_VAR_NS("WarpXParticleContainer::DepositCharge::Accumulate", blp_accumulate, ablastr::profiler::WhenToProfile::IfSyncEnabled);
...
WarpXParticleContainer::DepositCharge (const ablastr::fields::MultiLevelScalarField& rho,
                                       ...
                                       const int icomp)
{
    WARPX_PROFILE("WarpXParticleContainer::DepositCharge", ablastr::profiler::WhenToProfile::Always);
...
{
    WARPX_PROFILE("WarpXParticleContainer::PushX()", ablastr::profiler::WhenToProfile::Always);
...
WarpXParticleContainer::ApplyBoundaryConditions (){
    WARPX_PROFILE("WarpXParticleContainer::ApplyBoundaryConditions()", ablastr::profiler::WhenToProfile::Always);
