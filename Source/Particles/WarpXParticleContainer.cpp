...
WarpXParticleContainer::ReadParameters ()
{
    ...
    if (!initialized)
    {
        ...
        pp_particles.query("do_temperature_deposition", this->do_temperature_deposition);
        initialized = true;
    }
}
...
WarpXParticleContainer::AllocData ()
{
    ...
    if (do_temperature_deposition) {
        ...
        const std::string T_field_name = "T_" + this->getSpeciesTypeName();
...
/* \brief Temeprature Deposition for thread thread_num
 * \param pti         Particle iterator
 * \param wp          Array of particle weights
 * \param uxp uyp uzp Array of particle momenta
 * \param ion_lev     Pointer to array of particle ionization level. This is
 ...
 */
void
WarpXParticleContainer::DepositTemperature (
    WarpXParIter& pti,
    RealVector const & wp, RealVector const & uxp,
    RealVector const & uyp, RealVector const & uzp,
    int const * const ion_lev,
...
void
WarpXParticleContainer::AccumulateVelocitiesAndComputeTemperature (
