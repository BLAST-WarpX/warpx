...
{
    WARPX_PROFILE("BackgroundMCCCollision::doCollisions()", ablastr::profiler::WhenToProfile::Always);
    using namespace amrex::literals;
...
{
    WARPX_PROFILE("BackgroundMCCCollision::doBackgroundIonization()", ablastr::profiler::WhenToProfile::Always);
