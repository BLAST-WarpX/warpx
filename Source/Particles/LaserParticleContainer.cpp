                                ...
                                ImplicitOptions const * implicit_options)
{
    ...
    WARPX_PROFILE("LaserParticleContainer::Evolve()", ablastr::profiler::WhenToProfile::Always);
    WARPX_PROFILE_VAR_NS("LaserParticleContainer::Evolve::ParticlePush", blp_pp, ablastr::profiler::WhenToProfile::IfSyncEnabled);
