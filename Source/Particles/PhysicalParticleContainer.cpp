                                   ...
                                   ImplicitOptions const * implicit_options)
{
    ...
    WARPX_PROFILE("PhysicalParticleContainer::Evolve()", ablastr::profiler::WhenToProfile::Always);
    WARPX_PROFILE_VAR_NS("PhysicalParticleContainer::Evolve::GatherAndPush", blp_fg, ablastr::profiler::WhenToProfile::IfSyncEnabled);
...
{
    WARPX_PROFILE("PhysicalParticleContainer::PushP()", ablastr::profiler::WhenToProfile::Always);
...
{
    WARPX_PROFILE("PhysicalParticleContainer::getIonizationFunc()", ablastr::profiler::WhenToProfile::Always);
...
void PhysicalParticleContainer::resample (const amrex::Vector<amrex::Geometry>& geom, const int timestep, const bool verbose)
{
    ...
    WARPX_PROFILE_VAR_NS("MultiParticleContainer::doResampling::MPI_synchronization",
                         blp_resample_synchronization, ablastr::profiler::WhenToProfile::Always);
    WARPX_PROFILE_VAR_NS("MultiParticleContainer::doResampling::ActualResampling",
                         blp_resample_actual, ablastr::profiler::WhenToProfile::Always);
...
{
    WARPX_PROFILE("PhysicalParticleContainer::findRefinedInjectionBox", ablastr::profiler::WhenToProfile::Always);
...
{
    WARPX_PROFILE("PhysicalParticleContainer::getPhotonEmissionFunc()", ablastr::profiler::WhenToProfile::Always);
...
{
    WARPX_PROFILE("PhysicalParticleContainer::getPairGenerationFunc()", ablastr::profiler::WhenToProfile::Always);
    ...
    const warpx::particles::deposition::TemperatureDepositionPass pass)
{
    ...
    WARPX_PROFILE("PhysicalParticleContainer::DepositTemperature()", ablastr::profiler::WhenToProfile::Always);
