...
MultiParticleContainer::doFieldIonization (int lev,
                                           ...
                                           const MultiFab& Bz)
{
    WARPX_PROFILE("MultiParticleContainer::doFieldIonization()", ablastr::profiler::when::Always);
...
{
    WARPX_PROFILE("MultiParticleContainer::doCollisions()", ablastr::profiler::when::Always);
...
{
    WARPX_PROFILE("MultiParticleContainer::doQEDSchwinger()", ablastr::profiler::when::Always);
...
void MultiParticleContainer::doQedEvents (int lev,
                                          ...
                                          const MultiFab& Bz)
{
    WARPX_PROFILE("MultiParticleContainer::doQedEvents()", ablastr::profiler::when::Always);
...
void MultiParticleContainer::doQedBreitWheeler (int lev,
                                                ...
                                                const MultiFab& Bz)
{
    WARPX_PROFILE("MultiParticleContainer::doQedBreitWheeler()", ablastr::profiler::when::Always);
...
void MultiParticleContainer::doQedQuantumSync (int lev,
                                               ...
                                               const MultiFab& Bz)
{
    WARPX_PROFILE("MultiParticleContainer::doQedQuantumSync()", ablastr::profiler::when::Always);
