...
{
    WARPX_PROFILE("PhysicalParticleContainer::AddParticles()", ablastr::profiler::when::Always);
...
{
    WARPX_PROFILE("PhysicalParticleContainer::AddPlasma()", ablastr::profiler::when::Always);
...
{
    WARPX_PROFILE("PhysicalParticleContainer::AddPlasmaFlux()", ablastr::profiler::when::Always);
