...
{
    WARPX_PROFILE("PhysicalParticleContainer::AddParticles()", ablastr::profiler::Always);
...
{
    WARPX_PROFILE("PhysicalParticleContainer::AddPlasma()", ablastr::profiler::Always);
...
{
    WARPX_PROFILE("PhysicalParticleContainer::AddPlasmaFlux()", ablastr::profiler::Always);
